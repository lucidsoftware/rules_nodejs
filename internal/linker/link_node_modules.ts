...
/**
 * Create a temporary directory in which symbolic links can be written. We can't write these links to the runfiles
  ...
  for (const packagePath of Object.keys(roots)) {
    ...
    if (process.env['RUNFILES']) {
      ...
      if (stat && stat.isDirectory()) {
        ...
        // Update NODE_PATH to include the writable runfiles directory
